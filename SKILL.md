---
name: spotify
description: "Control Spotify playback — play, pause, skip, search, queue, volume, and view now-playing status from OpenClaw."
metadata: { "openclaw": { "emoji": "🎵", "requires": { "bins": ["spotify-ctl"] } } }
---
...
- Play, pause, resume, or skip a song
